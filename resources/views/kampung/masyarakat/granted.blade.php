...
@section('content')
    <div class="mb-3">
        <span class="fs-4">Data Masyarakat (Granted)</span>
        <div class="btn-group float-end">
            <a href="{{ route('kampung.masyarakat.index') }}" class="btn btn-outline-primary">All</a>
            <a href="{{ route('kampung.masyarakat.waiting') }}" class="btn btn-outline-warning">Waiting</a>
            <a href="{{ route('kampung.masyarakat.granted') }}" class="btn btn-success">Granted</a>
        </div>
    </div>
